...
<nav class=" w-full fixed z-20 bg-light-primary border-gray-200 px-2 sm:px-4 py-2.5 rounded " :class="{'bg-light-primary dark:bg-dark-primary':scrolllBg,'bg-white dark:bg-slate-800':!scrollBg}">
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    <a href="http://localhost:8000/image/top.jpg" class="flex items-center">
        ...
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Michael Adeleke</span>
    </a>
    ...
    <div class="w-full md:block md:w-auto" :class="{ hidden: showMobileMenu}" id="navbar-default">
      <ul class="flex flex-col p-4 mt-4 bg-light-secondary rounded-lg border border-light-tail-500 
